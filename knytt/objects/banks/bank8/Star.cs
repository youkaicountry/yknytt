...
public class Star : GDKnyttBaseObject
{
    ...
    private void startSleep()
    {
        ...
        timer.WaitTime = GDKnyttDataStore.random.NextFloat(MIN_SLEEP, MAX_SLEEP);
        timer.Start();
    }
    ...
    private void startAnimation()
    {
        ...
        anim.Position = new Vector2(GDKnyttDataStore.random.NextFloat(24f), GDKnyttDataStore.random.NextFloat(24f));

        anim.Visible = true;
        anim.Stop();
        anim.Frame = 0;
        anim.Play(""+GDKnyttDataStore.random.Next(0, 4));
    }

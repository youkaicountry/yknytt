...
public partial class ArtifactsPanel : Control
{
    ...
    public override void _Ready()
    {
        ...
        {
            GetNode<TextureRect>("CoinControl/CoinIcon").Texture = world.getWorldTexture2D(COIN_ICON_PATH) as Texture2D;
        }
        ...
        for (int i = 1; i <= 7; i++)
        {
            ...
            texture.Atlas = world.getWorldTexture2D(image_path) as Texture2D;
        }
    }

namespace YKnyttLib
{
    public static class KnyttUtil
    {
        ...
        public static float B(int kc) { return ((0xFF0000 & kc) >> 16) / (float)0xFF; }

        public static float G(int kc) { return ((0xFF00 & kc) >> 8) / (float)0xFF; }

        public static float R(int kc) { return (0xFF & kc) / (float)0xFF; }
    }
}
